...
namespace TanksGame
{
    public class GameWorld
    {
        ...
        public void LoadLevel(int levelNumber)
        {
            ...
            // Точки спавна
            SpawnPoints.Add(new Point(20, 20)); // Враг 1
            SpawnPoints.Add(new Point(Width - 60, 20)); // Враг 2
            SpawnPoints.Add(new Point(Width / 2, Height - 60)); // Враг 3
        }
